...
def build_daily_tmax(
    ...
    # Keep days even if there are no valid observations.
    # In that case, tmax_c/tmax_f will be null, coverage_hours == 0, and
    # QC_INCOMPLETE_DAY will be set. Downstream can decide how to filter.
